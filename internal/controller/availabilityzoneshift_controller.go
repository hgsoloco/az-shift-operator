...
import (
	"context"
	"fmt"
	v1alpha "github.com/aws/karpenter-core/pkg/apis/v1alpha5"
...
func (r *AvailabilityZoneShiftReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	fmt.Printf("hello")
	prov := v1alpha.ProvisionerList{}
	var listOpts []client.ListOption

	if err := r.List(ctx, &prov, listOpts...); err != nil {
		fmt.Printf("no provs")
	}
...
func (r *AvailabilityZoneShiftReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&zonalshiftmgrv1.AvailabilityZoneShift{}).
		Complete(r)
}
